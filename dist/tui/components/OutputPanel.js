...
export function OutputPanel({ agent, maxLines = 30 }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "single", borderColor: roleColor, flexGrow: 1, children: [_jsxs(Box, { paddingX: 1, gap: 1, children: [_jsx(Text, { bold: true, color: roleColor, children: ROLE_LABELS[agent.role] ?? agent.role }), _jsx(Text, { color: theme.dim, children: "\u00B7" }), _jsx(Text, { color: theme.dim, children: agent.tool }), agent.model && (_jsxs(_Fragment, { children: [_jsx(Text, { color: theme.dim, children: "\u00B7" }), _jsx(Text, { color: theme.dim, children: agent.model })] })), agent.cost != null && agent.cost > 0 && (_jsxs(_Fragment, { children: [_jsx(Text, { color: theme.dim, children: "\u00B7" }), _jsxs(Text, { color: theme.muted, children: ["$", agent.cost.toFixed(4)] })] }))] }), _jsx(Box, { flexDirection: "column", paddingX: 1, flexGrow: 1, children: lines.length === 0 ? (_jsx(Text, { color: theme.dim, dimColor: true, children: "Waiting for output\u2026" })) : (lines.map((line, i) => _jsx(OutputLine, { line: line }, i))) })] }));
}
